...
extern double x_ref, y_ref; //used by MPU6050_store_reference() to store the reference normalized (x,y) vector
...
// Inits the MPU and returns 0 if all okay. Also calls Wire.begin()
int MPU6050_init();
